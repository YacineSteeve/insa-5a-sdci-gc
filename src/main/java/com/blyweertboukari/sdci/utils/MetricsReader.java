...
public class MetricsReader {
    ...
    public static String getMetric(Metric metric) throws IOException, InterruptedException {
    ...
    private static String queryPrometheus(String query) throws IOException, InterruptedException {
